...
if (process.argv.includes('help')) {
    ...
    console.log('  in: Input file name (default "input")')
    ...
    console.log('  abd: audio bit depth (default s16le, use ffmpeg -formats to list, common values include u8, u16le, u16be, s8, s16le, s16be)');
...
const audioBitDepth = args.abd ?? 's16le'; // changing the bit depth breaks default sample rate
